...
// const ListMarketData = () => {
//     const [marketInfo, setMarketInfo] = useState<MarketInfo[]>([]);

//     // const handleAddMarketInfo = () => {
//     //     const updatedMarketInfo = addMarketInfoToList(marketInfo);
...
// const addMarketInfoToList = (marketInfo: MarketInfo[]): MarketInfo[] => {
//     const newMarketInfo: MarketInfo = {
//         code: marketInfo.code,
//         alis: marketInfo.alis,
//         satis: marketInfo.satis,
//         dusuk: 0,
//         yuksek: 0,
//         kapanis: 0,
//         tarih: marketInfo.tarih;
//     }
//     return [...marketInfo, newMarketInfo];
// }